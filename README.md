...
|-----------|-------|-------------|
| **Skills** | 39 | Slash commands for common tasks (`/proofread`, `/latex-autofix`, `/literature`, etc.) |
...
39 skills available. Key examples: `/proofread`, `/latex-autofix`, `/literature`, `/bib-validate`, `/code-review`, `/session-recap`, and more.
<!-- SKILLS-SUMMARY:END -->
