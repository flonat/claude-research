...
|-----------|-------|-------------|
| **Skills** | 45 | Slash commands for common tasks (`/proofread`, `/latex-autofix`, `/literature`, etc.) |
...
| **Rules** | 8 | Always-on policies (plan before implementing, scope discipline, etc.) |
...
45 skills available. Key examples: `/proofread`, `/latex-autofix`, `/literature`, `/bib-validate`, `/code-review`, `/session-recap`, and more.
<!-- SKILLS-SUMMARY:END -->
...
│   ├── rules/                   # 8 auto-loaded policy rules
...
├── mcp-scholarly/               # Multi-source scholarly search (OpenAlex + Scopus + WoS)
├── packages/
