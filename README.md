...
|-----------|-------|-------------|
| **Skills** | 85 | Slash commands for common tasks (`/proofread`, `/latex-autofix`, `/literature`, etc.) |
...
85 skills available. Key examples: `/proofread`, `/literature`, `/bib-validate`, `/init-project-research`, `/pre-submission-report`, and more.
<!-- SKILLS-SUMMARY:END -->
