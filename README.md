...
|-----------|-------|-------------|
| **Skills** | 108 | Slash commands for common tasks (`/proofread`, `/latex-autofix`, `/literature`, etc.) |
...
108 skills available. Key examples: `/proofread`, `/literature`, `/bib-validate`, `/init-project-research`, `/pre-submission-report`, and more.
<!-- SKILLS-SUMMARY:END -->
