...
|-----------|-------|-------------|
| **Skills** | 48 | Slash commands for common tasks (`/proofread`, `/latex-autofix`, `/literature`, etc.) |
...
48 skills available. Key examples: `/proofread`, `/latex-autofix`, `/literature`, `/bib-validate`, `/code-review`, `/init-project-research`, and more.
<!-- SKILLS-SUMMARY:END -->
